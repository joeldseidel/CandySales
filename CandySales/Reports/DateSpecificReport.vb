...
Public Class DateSpecificReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CandySales.DateSpecificReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDateSpecificReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DateSpecificReport = New DateSpecificReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
